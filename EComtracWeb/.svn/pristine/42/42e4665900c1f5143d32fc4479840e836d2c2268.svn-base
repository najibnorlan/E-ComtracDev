...
//						newParticipant.setDesignation(participantsubmit.getDesignation());
						...
						newParticipant.setIsRefund(Parameter.YES_NO_no);
...
//						selectedParticipant.setDesignation(participantsubmit.getDesignation());
						...
						if (!Parameter.YES_NO_yes.equals(selectedParticipant.getIsRefund())) {
							selectedParticipant.setIsRefund(Parameter.YES_NO_no);
						}
